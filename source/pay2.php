...
<head>
    ...
    <title><?php echo $langs['wechat_pay']; ?></title>
    <script>
...
<body>
    ...
    <div class="body">
        <h1 class="mod-title">
            <span class="ico-wechat"></span><span class="text"><?php echo $langs['wechat_pay']; ?></span>
        </h1>
        <div class="mod-ct">
            <div class="order">
            </div>
            ...
            <div class="detail detail-open" id="orderDetail" style="">
                <dl class="detail-ct" style="display: block;">
                    <dt><?php echo $langs['merchant']; ?></dt>
                    <dd id="storeName"><?php echo $langs['tencent_cloud']; ?></dd>
                    <dt><?php echo $langs['product_name']; ?></dt>
                    <dd id="productName"><?php echo $langs['account_recharge']; ?></dd>
                    <dt>交易单号</dt>
            ...
            <div class="tip">
                ...
                <div class="tip-text">
                    <p><?php echo $langs['use_weshat_to_scan']; ?></p>
                    <p><?php echo $langs['scan_qr_payment']; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="foot">
            <div class="inner">
                <p><?php echo $langs['question_about_trans']; ?></p>
                <p><?php echo $langs['contact_qq']; ?> <a href="javascript:void(0);" class="link">800033878</a></p>
            </div>
        </div>
    ...
    <script src="//qzonestyle.gtimg.cn/c/=/open/qcloud/jquery-1.7.1.min.js,/open/qcloud/qcloud_util.js?v=201605201"></script>
    <div style="width:720px;height:380px;display:none;">
        <div id="video-dialog"></div><a href="javascript:void(0);" onclick="return false;" style="position:absolute;right:-25px;top:-20px;" id="close_video_btn" class="ico-video-close"></a>
    </div>
    ...
    <script>
        var rechargedata = {
            ...
            "data": {
                ...
                "ownerUin": 912750350,
                "storeName": "\u817e\u8baf\u4e91",
                "productName": "912750350\u8d26\u6237\u5145\u503c",
                "QRCode": "",
                "billId": "20160904010000022476570553059860",
                "createTime": "2016-09-04 16:24:51",
                "amount": 6800,
                "payChoice": "wechatpay",
                "attach": "{\"uin\":\"912750350\",\"ownerUin\":\"912750350\",\"dealIds\":[2173561],\"from\":\"newPayPage\",\"rechargeForDeal\":1,\"payMode\":1}",
                "payMode": 1,
                "rechargeForDeal": 0,
                "dealIds": []
            }
