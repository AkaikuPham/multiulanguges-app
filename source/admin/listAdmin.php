            ...
            <tbody>
                <?php foreach ($rows as $row) : ?>
                    <tr align="center">
                        ...
                        <td align="center"><a class="btn btn-link" onclick="editAdmin(<?php echo $row['id']; ?>)"><?php echo $langs['revise']; ?></a><a class="btn btn-link" onclick="delAdmin(<?php echo $row['id']; ?>)">删除</a></td>
                    </tr>
                <?php endforeach; ?>
