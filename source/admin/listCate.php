            ...
            <tbody>
                <?php foreach ($rows as $row) : ?>
                    <tr>
                        ...
                        <td align="center"><a class="btn btn-link" onclick="editCate(<?php echo $row['id']; ?>)"><?php echo $langs['revise']; ?></a><a class="btn btn-link" onclick="delCate(<?php echo $row['id']; ?>)">删除</a></td>
                    </tr>
                <?php endforeach; ?>
