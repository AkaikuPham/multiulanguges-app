    ...
    <div class="details">
        ...
        <table class="table  table-hover">
            <thead>
                <tr>
                    <th width="15%">商品编号</th>
                    <th width="15%"><?php echo $langs['product_name']; ?></th>
                    <th width="10%">商品分类</th>
                    <th width="10%">所属店铺</th>
                    <th width="10%">价格</th>
                    <th width="10%">发布时间</th>
                ...
                <?php if (isset($rows)) : ?>
                    <?php foreach ($rows as $row) : ?>
                        <tr align="center">
                            ...
                            <td>
                                <a class="btn btn-link" onclick="editPro(<?php echo $row['id']; ?>,<?php echo $row['pSn']; ?>)"><?php echo $langs['revise']; ?></a><a class="btn btn-link" onclick="delPro(<?php echo $row['id']; ?>)">删除</a>
