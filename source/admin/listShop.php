            ...
            <tbody>
                <?php foreach ($rows as $row) : ?>
                    <tr>
                        ...
                        <td align="center"><a class="btn btn-link" onclick="editShop(<?php echo $row['shopId']; ?>)"><?php echo $langs['revise']; ?></a><a class="btn btn-link" onclick="delShop(<?php echo $row['shopId']; ?>)">删除</a></td>
                    </tr>
                <?php endforeach; ?>
